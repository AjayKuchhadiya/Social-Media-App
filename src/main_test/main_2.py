...
# Here using ORM to connect with database and using python code to communicate with database that is being converted to SQL by ORM. 
...
# Dependency
def get_db():
    db = SessionLocal()   # this session object is actually responsible for communication with the database. 
    try : 
        yield db
    finally : 
        db.close()
